Pod::Spec.new do |s|
  ...
  s.platform     = :ios, '6.0'
  s.source       = { :git => "https://github.com/frnde/MDMultilineTextView.git", :commit => "45236b8cec6a9a30bf449894cc6e2682af3a75c1" }
